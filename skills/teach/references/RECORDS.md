...
Learning records live in `./learning-records/`, sequential numbering: `0001-slug.md`, `0002-slug.md`, etc. Create directory lazily — only when first record written.

Teaching equivalent of ADRs: capture non-obvious lessons, key insights, stated prior knowledge that steer future sessions. Used to calculate zone of proximal development.
