...
- **Which optional line appear at all** — an argument marked optional ([COMPONENTS.md § Template arguments](COMPONENTS.md#template-arguments)) drop with its element. A lesson that keep every one of them is a lesson shaped by the template.
