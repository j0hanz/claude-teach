...
- **Motion** — reduced-motion mean no transition, instant release; blur stay (static mask, not movement). Default motion subtle (seal ~0.6s, quiz state ~0.15s). No scroll reveal, no ambient animation.
